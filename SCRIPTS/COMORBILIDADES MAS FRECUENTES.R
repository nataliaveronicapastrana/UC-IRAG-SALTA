...
TABLA_COMORB_GT <- TABLA_COMORB %>%
  ...
  tab_source_note(
    source_note = "Nota: Los porcentajes se calculan sobre el total de casos de IRAG (n = 733). Cada paciente puede presentar más de una comorbilidad, por lo que los porcentajes no suman 100%."
  )
